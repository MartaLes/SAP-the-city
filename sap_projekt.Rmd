...
značajan prediktor depresije (b = −0.40, p \< 0.001), dok su
makiavelizam (b = 0.21, p \< 0.001) i psihoticizam (b = 0.28, p \<
...
je bio najsnažniji pozitivni prediktor depresije (b = 0.46, p \< 0.001),
dok je ekstraverzija imala značajan negativan učinak (b = −0.24, p \<
0.001). Psihoticizam je također pokazao umjeren, ali značajan pozitivan
doprinos (b = 0.17, p = 0.0018). Narcizam, savjesnost i ugodnost nisu
...
Distribucije u skupinama su priližno normalne. Zatim ćemo provjeriti
varijance.
