...
nastavku su prikazani rezultati testova.
...
skupine, ovdje su prikazani samo rezultati za skupine zaposlenih na
puno radno vrijeme i studenata radi vizualne reprezentacije. Postoje manja
odstupanja od normalnosti u skupini Part-Time, ali to je opravdano
manjim brojem članova te skupine.
...
unutar svih skupina osim kod nezaposlenih (p \< 0.05). Kod studentske skupine odstupanje je granično.
...
promatranih skupina - ne možemo odbaciti nultu hipotezu o normalnosti uzorka.
...
357) = 13.22 i p = 2.2x$10^{-16}$ (\< 0.001) te je Multiple R-squared =
0.3076 i Adjusted R-squared = 0.2843. Ove vrijednosti upućuju da model
ima dobru objašnjavajuću snagu.

Među mračnim crtama ličnosti, psihoticizam se istaknuo kao statistički
značajan pozitivan prediktor ($\beta$ = 0.2158670, p = 0.00192 (\<
...
povezanosti ($\beta$ = 0.1107641, p = 0.06075 (\< 0.1)), ali rezultati su
nedovoljni za snažnu povezanost. Narcizam i sadizam nisu pokazali
značajan doprinos.

Unutar petofaktorskog Big 5 modela, neuroticizam se pokazao daleko
najsnažnijim prediktorom ishoda ($\beta$ = 0.3993105, p = 3.05x$10^{-9}$
...
0.1384934, p = 0.00708 (\< 0.01). Ovaj podatak sugerira da osobe s više
